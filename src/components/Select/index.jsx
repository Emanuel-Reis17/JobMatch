const Select = ({ name, value, list, handleFunction }) => {
    return (
        <>
            ...
            <select className='bg-[var(--white2)] font-inter font-medium text-[var(--black4)] w-full py-[11px] px-[15px] rounded-lg' name={name.toLowerCase()} id={name.toLowerCase()} value={value} onChange={e => handleFunction(e.target.value)}>
